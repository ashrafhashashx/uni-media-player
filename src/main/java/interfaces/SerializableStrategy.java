...
public interface SerializableStrategy {
     ...
     */
    void writeSong(interfaces.Song s) throws IOException;

    /*
     Read a song from the recently opened medium
     */
    interfaces.Song readSong() throws IOException, ClassNotFoundException;

    /*
     Write songs from the library by calling writeSong for each Song in library
    */
    void writeLibrary(interfaces.Playlist p) throws IOException;

    /*
     Read songs into the library by calling readSong until null is returned
     */
    interfaces.Playlist readLibrary() throws IOException, ClassNotFoundException;

    /*
     Write a PlayList by calling writeSong for each Song
    */
    void writePlaylist(interfaces.Playlist p) throws IOException;

    /*
     Read a playlist by calling readSong until null is returned
     */
    interfaces.Playlist readPlaylist() throws IOException, ClassNotFoundException;
